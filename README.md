...
| [`panel-de-control/`](panel-de-control/README.md) | **Panel**: un centro de control estilo macOS con `Ctrl+Alt+A`: Wi-Fi, Bluetooth, luz nocturna, brillo, volumen y un interruptor por cada utilidad de esta carpeta. | 1.0.0, con instalador. Brillo por pantalla probado con tres monitores. |
