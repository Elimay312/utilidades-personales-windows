...
// leaf. `brush` is the one scratch solid brush the frame reuses, recoloured as it goes.
...
// A card: three DIP of calendar colour down the left, the time in secondary and the title in
